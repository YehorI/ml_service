...
router.add_api_route("/admin/balance/{target_user_id}", handlers.admin_get_balance, methods=["GET"], response_model=WalletBalanceResponse)
router.add_api_route("/admin/deposit", handlers.admin_deposit, methods=["POST"], response_model=WalletBalanceResponse)
